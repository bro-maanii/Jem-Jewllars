    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto py-8 px-4">
      <div className="grid mx-auto gap-4">
        ...
        <div className="grid grid-cols-3 w-4/5 gap-2">
          <div
            onClick={() => setActiveImg("/placeholder-user.jpg")}
            className="border w-4/5  rounded-lg overflow-hidden"
          >
            <Image
          ...
          <div
            onClick={() => setActiveImg("/heroImage.png")}
            className="border w-4/5 rounded-lg overflow-hidden"
          >
            <Image
              src="/heroImage.png"
          ...
          <div
            onClick={() => {
              setActiveImg("/placeholder-user.jpg");
            }}
            className="border  w-4/5  rounded-lg overflow-hidden"
          >
            <Image
      ...
      <div className="flex flex-col justify-center gap-4 mx-auto">
        ...
        <p className="font-extralight">
          ...
          ducimus. Id, rem, ad quia magni earum odio quisquam quaerat cum
          provident maxime ullam! Nobis quia vel obcaecati ex inventore debitis.
        </p>
